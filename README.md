...
1. In your repo, click on the **Pull requests** tab. :D
1. Click on the pull request you created in step 1.:D
1. Click **Merge pull request**, then click **Confirm merge**.
1. Optionally, click **Delete branch** to delete your `welcome-workflow` branch.:D
